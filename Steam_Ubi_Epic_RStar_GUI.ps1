...
$fontH=New-Object System.Drawing.Font('Segoe UI',10,[System.Drawing.FontStyle]::Bold)
...
$defs=@(
@('Steam','Block-Steam',45),
@('Ubisoft','Block-Ubi',90),
@('Epic Games','Block-Epic',135),
@('Rockstar','Block-Rockstar',180),
@('Custom Folder','Block-Custom',255),
@('Clear Rules','Show-ClearMenu',330)
)
...
foreach($d in $defs){
 ...
 $b.Location="20,$($d[2])"
 $fn=$d[1]
 $b.Add_Click([scriptblock]::Create("& $fn"))
 $form.Controls.Add($b)
}
...
$close.Text='Close'
$close.Size='120,35'
$close.Location='400,385'
$close.Add_Click({$form.Close()})
$form.Controls.Add($close)

$status=New-Object System.Windows.Forms.Label
$status.Text='Status: Ready'
$status.Location='20,392'
