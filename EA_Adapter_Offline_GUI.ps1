...
$title.Text = 'EA App Automated Offline Tool'
...
$btnLaunch.Text = 'Launch EA + Game in Offline Mode'
$btnLaunch.Size = '430,40'
$btnLaunch.Location = '20,70'
$btnLaunch.Add_Click({ Invoke-EaLaunchOffline })
$form.Controls.Add($btnLaunch)

$btnReset = New-Object System.Windows.Forms.Button
$btnReset.Text = 'Emergency Cleanup / Reset'
$btnReset.Size = '430,40'
$btnReset.Location = '20,120'
$btnReset.Add_Click({ Invoke-EaForceCleanup })
$form.Controls.Add($btnReset)

$btnClose = New-Object System.Windows.Forms.Button
$btnClose.Text = 'Close'
$btnClose.Size = '120,35'
$btnClose.Location = '330,175'
