...
$form.Text='Ultimate Firewall and EA Offline Manager'
$form.Size=New-Object Drawing.Size(520,420)
$form.StartPosition='CenterScreen'

$buttons=@(
@('Block Steam','Block-Steam'),
@('Block Ubisoft','Block-Ubi'),
@('Block Epic Games','Block-Epic'),
@('Block Rockstar','Block-Rockstar'),
@('EA Adapter Offline','Show-EaAdapterMenu'),
@('Block Custom Folder','Block-Custom'),
@('Clear Firewall Rules','Show-ClearMenu')
)
...
foreach($b in $buttons){
 ...
 $btn.Location="25,$y"
 $fn=$b[1]
 $btn.Add_Click([scriptblock]::Create("& $fn"))
