...
# ==============================================================================
# 3. MODERN DARK UI SETUP (EXPANDED DYNAMIC TYPOGRAPHY)
# ==============================================================================
$form = New-Object Windows.Forms.Form
$form.Text = "Offline Activation & Utility Manager"
$form.Size = New-Object Drawing.Size(820, 800) # Expanded for larger fonts
...
# Header Title (Modern Bold Display Font)
...
# Main ListBox (Increased Font Size & Text Height)
...
# Console Output Box (Sharp Terminal Font)
